            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex justify-between items-center p-4 border rounded">
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-500">passenger@example.com</p>
                </div>
                <span className="px-2 py-1 bg-green-100 text-green-800 rounded text-sm sm:text-base">Active</span>
              </div>
              <div className="flex justify-between items-center p-4 border rounded">
                <div>
                  <p className="font-medium">Driver Silva</p>
                  <p className="text-sm sm:text-base text-gray-500">driver@example.com</p>
                </div>
                <span className="px-2 py-1 bg-green-100 text-green-800 rounded text-sm sm:text-base">Active</span>
              </div>
            </div>
          ...
          <div className="bg-white p-3 sm:p-4 lg:p-6 rounded-lg shadow">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="p-4 border rounded">
                ...
                <p className="text-sm sm:text-base text-gray-500">2 buses active</p>
              </div>
              <div className="p-4 border rounded">
                <p className="font-medium">Colombo - Galle</p>
                <p className="text-sm sm:text-base text-gray-500">1 bus active</p>
              </div>
            </div>
          </div>
        );
          ...
          <div className="bg-white p-3 sm:p-4 lg:p-6 rounded-lg shadow">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="p-4 border rounded">
                ...
                <p className="text-sm sm:text-base text-gray-500">3 attempts in last hour</p>
              </div>
              <div className="p-4 border rounded">
                <p className="font-medium">System Health</p>
                <p className="text-sm sm:text-base text-green-600">All systems operational</p>
              </div>
            </div>
          </div>
        );
          ...
          <div className="bg-white p-3 sm:p-4 lg:p-6 rounded-lg shadow">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="p-4 border rounded">
                ...
                <p className="text-sm sm:text-base text-gray-500">Manage external integrations</p>
              </div>
              <div className="p-4 border rounded">
                <p className="font-medium">Notification Settings</p>
                <p className="text-sm sm:text-base text-gray-500">Configure system alerts</p>
              </div>
            </div>
          </div>
        );
