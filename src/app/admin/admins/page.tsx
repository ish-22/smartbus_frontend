...
export default function AdminManagementPage() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 overflow-x-hidden">
        ...
        <Card className="p-3 sm:p-4 lg:p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3 min-w-0">
              ...
              <p className="text-base sm:text-lg lg:text-xl font-bold text-gray-900">{admins.length}</p>
            </div>
          </div>
        </Card>
        <Card className="p-3 sm:p-4 lg:p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3 min-w-0">
              ...
              <p className="text-base sm:text-lg lg:text-xl font-bold text-gray-900">{admins.filter(a => a.status === 'Active').length}</p>
            </div>
          </div>
        </Card>
        <Card className="p-3 sm:p-4 lg:p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3 min-w-0">
              <p className="text-xs sm:text-sm font-medium text-gray-600 truncate">Super Admins</p>
              <p className="text-base sm:text-lg lg:text-xl font-bold text-gray-900">{admins.filter(a => a.role === 'Super Admin').length}</p>
            </div>
          </div>
        </Card>
      </div>
      ...
      {showAddForm && (
        <Card className="p-3 sm:p-4 lg:p-6">
          <h3 className="text-base sm:text-lg lg:text-xl font-semibold mb-3 sm:mb-4">Add New Admin</h3>
              ...
              {admins.map((admin) => (
                <tr key={admin.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-sm sm:text-base text-gray-500">ID: {admin.id}</div>
                  </td>
