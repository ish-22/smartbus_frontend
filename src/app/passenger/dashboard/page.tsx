    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link href="/passenger/search" className="group">
              <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
                <div className="w-12 h-12 bg-blue-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                  <span className="text-white text-xl">🔍</span>
                </div>
                <h2 className="text-xl font-bold text-gray-800 mb-2">Track Buses</h2>
                <p className="text-gray-600 mb-4">Find and track buses in real-time with GPS precision</p>
            ...
            <Link href="/passenger/booking" className="group">
              <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
                ...
                <h2 className="text-xl font-bold text-gray-800 mb-2">Book Seats</h2>
                <p className="text-gray-600 mb-4">Reserve your seat online with instant confirmation</p>
            ...
            <Link href="/passenger/tickets" className="group">
              <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
                ...
                <p className="text-gray-600 mb-4">View your booking history and active tickets</p>
            ...
            <Link href="/passenger/rewards" className="group">
              <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
                ...
                <p className="text-gray-600 mb-4">Earn points and redeem exclusive offers</p>
            ...
            <Link href="/lost-found" className="group">
              <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
                ...
                <h2 className="text-xl font-bold text-gray-800 mb-2">Lost & Found</h2>
                <p className="text-gray-600 mb-4">Report or claim lost items from your journey</p>
            ...
            <Link href="/feedback" className="group">
              <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
                ...
                <p className="text-gray-600 mb-4">Share your experience and help us improve</p>
